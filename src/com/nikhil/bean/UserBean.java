...
public class UserBean  implements java.io.Serializable {
    ...
    /**
     * Gets the city value for this UserBean.
     * 
     * @return city
     */
    ...
    /**
     * Sets the city value for this UserBean.
     * 
     * @param city
     */
    ...
    /**
     * Gets the first_name value for this UserBean.
     * 
     * @return first_name
     */
    ...
    /**
     * Sets the first_name value for this UserBean.
     * 
     * @param first_name
     */
    ...
    /**
     * Gets the last_login value for this UserBean.
     * 
     * @return last_login
     */
    ...
    /**
     * Sets the last_login value for this UserBean.
     * 
     * @param last_login
     */
    ...
    /**
     * Gets the last_name value for this UserBean.
     * 
     * @return last_name
     */
    ...
    /**
     * Sets the last_name value for this UserBean.
     * 
     * @param last_name
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://bean.nikhil.com", "UserBean"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://bean.nikhil.com", "email"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("first_name");
        elemField.setXmlName(new javax.xml.namespace.QName("http://bean.nikhil.com", "first_name"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://bean.nikhil.com", "last_name"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("password");
        elemField.setXmlName(new javax.xml.namespace.QName("http://bean.nikhil.com", "password"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
